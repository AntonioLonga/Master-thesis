...
def gen_transf_autoencoder(batch_size,validation_split,epochs,patience,verbose=0,scaler=None,dim=[2,3,5],plot=False):
    ...
    transf = Transformer_autoencoder(autoencoder,encoder,batch_size,validation_split,epochs,patience,verbose,scaler,dim,plot)
...
def generate_GNN(max_n_nodes,n_attributes,n_classes,batch_size = 32,
                 validation_split = 0.1,epochs = 100,patience=10,verbose=0, plot=False):
...
def  gen_gnn_dense(max_n_nodes, n_attributes,batch_size,validation_split,epochs,dim,patience,plot=False):
...
def  gen_gnn_small(max_n_nodes, n_attributes,batch_size,validation_split,epochs,dim,patience,verbose=False,plot=False):
